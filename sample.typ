...
#show: main.with(
  title: [象の卵は大きい象], authors: [象山象太郎], abstract: [古来より象の卵はもし存在するのならばとても大きいであろうと考えられてきた．
...
そこで我々は象型のドローンを開発し象の群れに忍ばせることによって象の生態を bla
bla bla
...
= 謝辞
本研究は一切の補助を受けておらず自費にて行った． また本論は @zouyama2015theory
@zouyama2017drone @zouyama2021AiL に依拠するものである．
...
#show: thebibliography.with(bibliography("sample_refs.yml"))
